...
namespace _05_Loops
{
    ...
    public class LoopExamples
    {
        ...
        public void WhileLoops()
        {
            ...
            while (total < 10)
            {
                Console.WriteLine(total); //or just Console.WriteLine(total++)
                total = total + 1; //or += 1 or total++; 
            }
        ...
        {
            int studentCount = 16;
            // 1 - Initial action - happens at the start 
            // 2 - Loop Condition - keep looping while this == true
            // 3 - Iterate action - happens at the end of every loop
